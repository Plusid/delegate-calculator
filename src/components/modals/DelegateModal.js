...
module.exports = {
  template: `
    ...
    >
      ...
      <ListDivided>
        ...
        <ListDividedItem
          label="Votes"
          :value="formatCurrency(delegate.votes, 'INF')"
        />
      ...
      <ListDivided>
        ...
        <ListDividedItem
          ...
          :value="formatCurrency(delegate.payout.minimum, 'INF')"
        />
        ...
        <ListDividedItem
          ...
          :value="formatCurrency(delegate.payout.payout_minimum_vote_amount, 'INF')"
        />

        <ListDividedItem
          v-if="delegate.payout.payout_maximum_vote_amount"
          label="Maximum Regarded Vote-Weight"
          :value="formatCurrency(delegate.payout.payout_maximum_vote_amount, 'INF')"
        />
      </ListDivided>
  ...
  methods: {
    ...
    formatCurrency (value, currency) {
      return utils.formatter_currency(Number(value) / 1e5, currency, this.profile.language)
    }
  }
}
